...
namespace RecodeMvc
{
    public class DestinoesController : Controller
    {
        ...
        public DestinoesController(DestinoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Destino,NomeDestino,DataIda,DataVolta")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Destino,NomeDestino,DataIda,DataVolta")] Destino destino)
        {
