...
namespace RecodeMvc
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Contato,Celular,Email,Github")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Contato,Celular,Email,Github")] Contato contato)
        {
